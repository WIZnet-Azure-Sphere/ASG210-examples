# ASG210M4 real-time application sample: DHCP_Server_RTApp
...
1. Start Visual Studio, From the File menu, select `Open` > `Folder` and navigate to the current sample path, `DHCP_Server_RTApp`.
...
1. Open `DHCP_Server_RTApp` folder.
