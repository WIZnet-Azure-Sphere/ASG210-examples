...
#else
// mB2
uint8_t spi_master_port_num = OS_HAL_SPIM_ISU2;
#endif
...
// ASG EVB V1.0
#if 1
static const uint8_t gpio_mB1_nSelspi = OS_HAL_GPIO_6;
static const uint8_t gpio_mB1_reset = OS_HAL_GPIO_0;
static const uint8_t gpio_mB1_int = OS_HAL_GPIO_1;

static const uint8_t gpio_mB2_nSelspi = OS_HAL_GPIO_7;
static const uint8_t gpio_mB2_reset = OS_HAL_GPIO_3;
static const uint8_t gpio_mB2_int = OS_HAL_GPIO_4;
#else
#if 1
// 20220516 taylor
// ASG210 V1.2
...
void w5500_init()
{
    gpio_output(gpio_mB1_nSelspi, OS_HAL_GPIO_DATA_LOW);
    gpio_output(gpio_mB2_nSelspi, OS_HAL_GPIO_DATA_LOW);

    // W5500 reset
    gpio_output(gpio_mB1_reset, OS_HAL_GPIO_DATA_LOW);
    gpio_output(gpio_mB2_reset, OS_HAL_GPIO_DATA_LOW);
    osai_delay_ms(1);

    gpio_output(gpio_mB1_reset, OS_HAL_GPIO_DATA_HIGH);
    gpio_output(gpio_mB2_reset, OS_HAL_GPIO_DATA_HIGH);
    osai_delay_ms(1);
