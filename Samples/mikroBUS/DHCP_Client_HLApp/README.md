# Sample: DHCP_Client_HLApp (High-level app)
...
|-------------|-------------|
| DHCP_Client_HLApp       |Sample source code and VS project files |
...
1. Start Visual Studio, From the File menu, select Open > Folder… and navigate to the folder, `DHCP_Client_HLApp`.
...
1. Open `DHCP_Client_HLApp` folder.
